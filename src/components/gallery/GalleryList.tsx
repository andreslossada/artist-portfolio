    ...
    <div className="space-y-4">
      {artworks.map((artwork) => (
        <Link
          ...
          className="group border-ink/10 hover:border-accent/35 relative grid grid-cols-[92px_1fr] items-stretch overflow-hidden border bg-surface shadow-card transition-colors [opacity:1] md:grid-cols-[160px_1fr]"
        >
          <ViewTransition
